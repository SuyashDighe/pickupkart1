...
const Schedule = () =>{
    const[pickupdate,setpickupdate]=useState({
      ...
      const handleChange = (e)=>{
        setpickupdate(prev=>({...prev,[e.target.name]:e.target.value}))
      };
      ...
      const handleClick = async e =>{
        e.preventDefault()
        try{
          //await axios.post("http://localhost:8700/books",pickupdate)
          //const id=book.id;
          var datedetail={pickupdate:pickupdate.pickupdate}
          console.log(datedetail);
          window.sessionStorage.setItem("datedetail",JSON.stringify(datedetail));
    ...
    return(
        ...
        <section class="w-full relative bg-[url('')] h-[960px] img1">
            ...
            <div class="flex flex-row gap-12 pl-8 max-[475px]:pl-3 w-[70%] items-center mx-auto pt-24 max-[1400px]:w-[100%] max-[768px]:flex-col max-[1024px]:items-center max-[475px]:pt-10 max-[768px]:pt-10 ">
                ...
                <div class="flex flex-col pl-10 pt-3 gap-y-2 pb-20 max-[475px]:gap-0 max-[1024px]:pr-20 max-[1024px]:pl-6  bg-white rounded-xl border shadow-lg max-[475px]:pl-6 max-[475px]:pr-12 pr-24 max-[768px]:pb-8 max-[768px]:pt-0 ">
                    <p class="pt-5 pb-8 pl-2 text-2xl font-ROBOTO text-[#EAB54F]">Schedule pickup</p>

                    <label class="text-xl font-ROBOTO" for="">Pickup Date</label>

                    <form class="  pl-0 max-[475px]:pl-0 px-1  mb-4 relative">
                        {/* <img src={Vectorright} class="absolute right-7 top-5 max-[1024px]:right-8" alt=""/>  */}
                        <input type="date" onChange={handleChange} placeholder="Choose Date" class="pl-6 pr-72 py-3 max-[475px]:pr-0 max-[475px]:pl-2 max-[1024px]:pr-20  max-[1024px]:py-2
                             transition-all duration-200 border border-gray-200 shadow-md rounded-lg font-mullish outline- 
                              lightBlue placeholder:text-base max-[475px]:placeholder:text-xs " name="pickupdate"/>

                    </form>

<Link to="/Report">
    <button onClick={handleClick} class="w-[450px] max-[475px]:text-[13px] max-[475px]:w-[150px] max-[1024px]:w-[243px] max-[1024px]:h-[40px] h-[49px] text-black text-[16px] font-semibold font-ROBOTO rounded-lg mt-5 bg-[#EDEDED]">Next</button>
                 ...
                 <div class="flex flex-col gap-10">
                    ...
                    <div class="flex flex-col pr-6 bg-white border max-[1024px]:ml-7 pb-6  max-[1024px]:pb-8 shadow-lg gap-14 pl-7 rounded-xl max-[1400px]:mr-8 max-[475px]:pl-3 ">
                    ...
                    <div class="flex flex-col pr-6 bg-white border max-[1024px]:ml-7  max-[1024px]:pb-8 shadow-lg gap-4 pl-7 rounded-xl max-[1400px]:mr-8 max-[475px]:pl-3 ">
                        <div class="text-[21px] font-ROBOTO font-bold mb-2 max-[640px]:text-[18px] pt-6">Parcel Details</div>
