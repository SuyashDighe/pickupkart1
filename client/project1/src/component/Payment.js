...
export default function Payment() {
  ...
  return (
    <div class="flex justify-center items-center min-h-screen bg-[#EAB54F]">
    <div class="h-auto w-80 bg-white p-3 rounded-lg">
        ...
        <div class="flex justify-center mt-4"> <button class="outline-none pay h-12 bg-orange-600 text-white mb-3 hover:bg-orange-700 rounded-lg w-1/2 cursor-pointer transition-all" onClick={handleClick}>Pay</button> </div>
    </div>
</div>
  );
}